...
import jns.command.LinkStateCommand;
 ...
 */
public class Test_MPTCP_Multiple_Sources_2
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            trace = new JavisTrace("test_mptcp_multisource_2.jvs");
        }
        catch(IOException e)
        {
            System.out.println("Could not create test_mptcp_linkdown.jvs!");
        }
        ...
        Interface ZBIface = new DuplexInterface(new IPAddr(192, 168, 0, 15));
        Z.attach(ZBIface);
        sim.attachWithTrace(ZBIface, trace);
        Interface ZCIface = new DuplexInterface(new IPAddr(192, 168, 0, 25));
        Z.attach(ZCIface);
        sim.attachWithTrace(ACIface, trace);
        Interface ZDIface = new DuplexInterface(new IPAddr(192, 168, 0, 35));
        Z.attach(ZDIface);
        sim.attachWithTrace(ADIface, trace);
        ...
        B.addRoute(new IPAddr(192, 168, 0, 15), new IPAddr(255, 255, 255, 0), BZIface);
        ...
        C.addRoute(new IPAddr(192, 168, 0, 25), new IPAddr(255, 255, 255, 0), CZIface);
        ...
        D.addRoute(new IPAddr(192, 168, 0, 35), new IPAddr(255, 255, 255, 0), DZIface);
        ...
        E.addRoute(new IPAddr(192, 168, 0, 15), new IPAddr(255, 255, 255, 0), EBIface);
        ...
        F.addRoute(new IPAddr(192, 168, 0, 25), new IPAddr(255, 255, 255, 0), FCIface);
        ...
        G.addRoute(new IPAddr(192, 168, 0, 35), new IPAddr(255, 255, 255, 0), GDIface);
        ...
        H.addRoute(new IPAddr(192, 168, 0, 15), new IPAddr(255, 255, 255, 0), HEIface);
        H.addRoute(new IPAddr(192, 168, 0, 25), new IPAddr(255, 255, 255, 0), HFIface);
        H.addRoute(new IPAddr(192, 168, 0, 35), new IPAddr(255, 255, 255, 0), HGIface);
        ...
        c_agent2.attach(new RandomSource(new IPAddr(192,168,0,15),
        								new IPAddr(192,168,0,8),
        								0.1,5),0);
        ...
        s_agent.addMapping(new IPAddr(192,168,0,15), new IPAddr(192,168,0,35));
        ...
        s_agent.addMapping(new IPAddr(192,168,0,25), new IPAddr(192,168,0,35));
        s_agent.addMapping(new IPAddr(192,168,0,35), new IPAddr(192,168,0,15));
        s_agent.addMapping(new IPAddr(192,168,0,35), new IPAddr(192,168,0,25));
        s_agent.addMapping(new IPAddr(192,168,0,35), new IPAddr(192,168,0,35));
        
        s_agent.attach( new RandomSink(new IPAddr(192,168,0,8), 0,12),0);
        H.attach(server_transport,Protocols.MPTCP);
        sim.schedule(new LinkStateCommand(0.6,be,Status.DOWN));
        new Thread(sim).start();

       
        sim.schedule(new StopCommand(100));
