 ...
 */
public class Test_MPTCP_Multiple_Sources_3
{
    ...
    public static void main(String args[])
    {
        ...
        Node Z = new Node("Z");
        sim.attachWithTrace(Z, trace);
        Node Y = new Node("Y");
        sim.attachWithTrace(Y, trace);
        ...
        Interface ZBIface = new DuplexInterface(new IPAddr(192, 168, 0, 5));
        Z.attach(ZBIface);
        sim.attachWithTrace(ZBIface, trace);
        Interface ZCIface = new DuplexInterface(new IPAddr(192, 168, 0, 15));
        Z.attach(ZCIface);
        sim.attachWithTrace(ZCIface, trace);
        Interface ZDIface = new DuplexInterface(new IPAddr(192, 168, 0, 25));
        Z.attach(ZDIface);
        sim.attachWithTrace(ZDIface, trace);
        
        Interface YBIface = new DuplexInterface(new IPAddr(192, 168, 0, 7));
        Y.attach(YBIface);
        sim.attachWithTrace(YBIface, trace);
        Interface YCIface = new DuplexInterface(new IPAddr(192, 168, 0, 17));
        Y.attach(YCIface);
        sim.attachWithTrace(YCIface, trace);
        Interface YDIface = new DuplexInterface(new IPAddr(192, 168, 0, 27));
        Y.attach(YDIface);
        sim.attachWithTrace(YDIface, trace);

        Interface BAIface = new DuplexInterface(new IPAddr(192, 168, 0, 2));
        B.attach(BAIface);
        sim.attachWithTrace(BAIface, trace);
        
        Interface BZIface = new DuplexInterface(new IPAddr(192, 168, 0, 2));
        B.attach(BZIface);
        sim.attachWithTrace(BZIface, trace);
        
        Interface BYIface = new DuplexInterface(new IPAddr(192, 168, 0, 2));
        B.attach(BYIface);
        sim.attachWithTrace(BYIface, trace);
        ...
        Interface CZIface = new DuplexInterface(new IPAddr(192, 168, 0, 3));
        C.attach(CZIface);
        sim.attachWithTrace(CZIface, trace);
        
        Interface CYIface = new DuplexInterface(new IPAddr(192, 168, 0, 3));
        C.attach(CYIface);
        sim.attachWithTrace(CYIface, trace);
        ...
        Interface DZIface = new DuplexInterface(new IPAddr(192, 168, 0, 4));
        D.attach(DZIface);
        sim.attachWithTrace(DZIface, trace);
        
        Interface DYIface = new DuplexInterface(new IPAddr(192, 168, 0, 4));
        D.attach(DYIface);
        sim.attachWithTrace(DYIface, trace);
        ...
        Link zb = new DuplexLink(500000, 0.008);
        Link zc = new DuplexLink(500000, 0.008);
        Link zd = new DuplexLink(500000, 0.008);
        Link yb = new DuplexLink(500000, 0.008);
        Link yc = new DuplexLink(500000, 0.008);
        Link yd = new DuplexLink(500000, 0.008);
        ...
        ZBIface.attach(zb, true);
        ZCIface.attach(zc, true);
        ZDIface.attach(zd, true);
        
        YBIface.attach(yb, true);
        YCIface.attach(yc, true);
        YDIface.attach(yd, true);
        ...
        sim.attachWithTrace(zb, trace);
        sim.attachWithTrace(zc, trace);
        sim.attachWithTrace(zd, trace);
        sim.attachWithTrace(yb, trace);
        sim.attachWithTrace(yc, trace);
        sim.attachWithTrace(yd, trace);
        ...
        Z.addRoute(new IPAddr(192, 168, 0, 8), new IPAddr(255, 255, 255, 0), ZBIface);
        Z.addRoute(new IPAddr(192, 168, 0, 90), new IPAddr(255, 255, 255, 0), ZCIface);
        Z.addRoute(new IPAddr(192, 168, 0, 100), new IPAddr(255, 255, 255, 0), ZDIface);
        
        Y.addRoute(new IPAddr(192, 168, 0, 8), new IPAddr(255, 255, 255, 0), YBIface);
        Y.addRoute(new IPAddr(192, 168, 0, 90), new IPAddr(255, 255, 255, 0), YCIface);
        Y.addRoute(new IPAddr(192, 168, 0, 100), new IPAddr(255, 255, 255, 0), YDIface);
        ...
        MPTCP client_transport2=new MPTCP();
        MPTCP client_transport3=new MPTCP();
        ...
        MPTCPAgent c_agent2 = client_transport2.createNewAgent(80);
        c_agent2.addMapping(new IPAddr(192,168,0,8), new IPAddr(192,168,0,8));
        c_agent2.addMapping(new IPAddr(192,168,0,8), new IPAddr(192,168,0,90));
        c_agent2.addMapping(new IPAddr(192,168,0,8), new IPAddr(192,168,0,100));
        c_agent2.addMapping(new IPAddr(192,168,0,90), new IPAddr(192,168,0,8));
        c_agent2.addMapping(new IPAddr(192,168,0,90), new IPAddr(192,168,0,90));
        c_agent2.addMapping(new IPAddr(192,168,0,90), new IPAddr(192,168,0,100));
        c_agent2.addMapping(new IPAddr(192,168,0,100), new IPAddr(192,168,0,8));
        c_agent2.addMapping(new IPAddr(192,168,0,100), new IPAddr(192,168,0,90));
        c_agent2.addMapping(new IPAddr(192,168,0,100), new IPAddr(192,168,0,100));
        c_agent2.attach(new RandomSource(new IPAddr(192,168,0,5),
        								new IPAddr(192,168,0,8),
        								0.2,3.0),0);
        Z.attach(client_transport2,Protocols.MPTCP);
        
        // ***** This is for Node Y ***** //
        
        MPTCPAgent c_agent3 = client_transport3.createNewAgent(80);
        c_agent3.addMapping(new IPAddr(192,168,0,8), new IPAddr(192,168,0,8));
        c_agent3.addMapping(new IPAddr(192,168,0,8), new IPAddr(192,168,0,90));
        c_agent3.addMapping(new IPAddr(192,168,0,8), new IPAddr(192,168,0,100));
        c_agent3.addMapping(new IPAddr(192,168,0,90), new IPAddr(192,168,0,8));
        c_agent3.addMapping(new IPAddr(192,168,0,90), new IPAddr(192,168,0,90));
        c_agent3.addMapping(new IPAddr(192,168,0,90), new IPAddr(192,168,0,100));
        c_agent3.addMapping(new IPAddr(192,168,0,100), new IPAddr(192,168,0,8));
        c_agent3.addMapping(new IPAddr(192,168,0,100), new IPAddr(192,168,0,90));
        c_agent3.addMapping(new IPAddr(192,168,0,100), new IPAddr(192,168,0,100));
        c_agent3.attach(new RandomSource(new IPAddr(192,168,0,7),
        								new IPAddr(192,168,0,8),
        								0.2,3.0),0);
        Y.attach(client_transport3,Protocols.MPTCP);
        ...
        s_agent.addMapping(new IPAddr(192,168,0,5), new IPAddr(192,168,0,5));
        s_agent.addMapping(new IPAddr(192,168,0,5), new IPAddr(192,168,0,15));
        s_agent.addMapping(new IPAddr(192,168,0,5), new IPAddr(192,168,0,25));
        s_agent.addMapping(new IPAddr(192,168,0,15), new IPAddr(192,168,0,5));
        s_agent.addMapping(new IPAddr(192,168,0,15), new IPAddr(192,168,0,15));
        s_agent.addMapping(new IPAddr(192,168,0,15), new IPAddr(192,168,0,25));
        s_agent.addMapping(new IPAddr(192,168,0,25), new IPAddr(192,168,0,5));
        s_agent.addMapping(new IPAddr(192,168,0,25), new IPAddr(192,168,0,15));
        s_agent.addMapping(new IPAddr(192,168,0,25), new IPAddr(192,168,0,25));
        
        s_agent.addMapping(new IPAddr(192,168,0,7), new IPAddr(192,168,0,7));
        s_agent.addMapping(new IPAddr(192,168,0,7), new IPAddr(192,168,0,17));
        s_agent.addMapping(new IPAddr(192,168,0,7), new IPAddr(192,168,0,27));
        s_agent.addMapping(new IPAddr(192,168,0,17), new IPAddr(192,168,0,7));
        s_agent.addMapping(new IPAddr(192,168,0,17), new IPAddr(192,168,0,17));
        s_agent.addMapping(new IPAddr(192,168,0,17), new IPAddr(192,168,0,27));
        s_agent.addMapping(new IPAddr(192,168,0,27), new IPAddr(192,168,0,7));
        s_agent.addMapping(new IPAddr(192,168,0,27), new IPAddr(192,168,0,17));
        s_agent.addMapping(new IPAddr(192,168,0,27), new IPAddr(192,168,0,27));
