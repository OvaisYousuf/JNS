 ...
 */
public class Test_MPTCP_2_link_down
{
    ...
    public static void main(String args[])
    {
        ...
        Interface BIIface = new DuplexInterface(new IPAddr(192, 168, 0, 2));
        B.attach(BIIface);
        sim.attachWithTrace(BIIface, trace);

        Interface IBIface = new DuplexInterface(new IPAddr(192, 168, 0, 30));
        I.attach(IBIface);
        sim.attachWithTrace(IBIface, trace);

		
        Interface IEIface = new DuplexInterface(new IPAddr(192, 168, 0, 30));
        I.attach(IEIface);
        sim.attachWithTrace(IEIface, trace);
        ...
        Interface EIIface = new DuplexInterface(new IPAddr(192, 168, 0, 5));
        E.attach(EIIface);
        sim.attachWithTrace(EIIface, trace);
        ...
        Link bi = new DuplexLink(500000, 0.008);
        Link ie = new DuplexLink(500000, 0.008);
        ...
        IBIface.attach(bi,true);
        EIIface.attach(ie,true);
        ...
        sim.attachWithTrace(bi, trace);
        sim.attachWithTrace(ie, trace);
        ...
        B.addRoute(new IPAddr(192, 168, 0, 8), new IPAddr(255, 255, 255, 0), BIIface);
        ...
        E.addRoute(new IPAddr(192, 168, 0, 1), new IPAddr(255, 255, 255, 0), EIIface);
        E.addRoute(new IPAddr(192, 168, 0, 8), new IPAddr(255, 255, 255, 0), EHIface);

		I.addRoute(new IPAddr(192, 168, 0, 1), new IPAddr(255, 255, 255, 0), IBIface);
        I.addRoute(new IPAddr(192, 168, 0, 8), new IPAddr(255, 255, 255, 0), IEIface);
        ...
        sim.schedule(new LinkStateCommand(0.6,bi,Status.DOWN));
        sim.schedule(new LinkStateCommand(0.6,eh,Status.DOWN));
